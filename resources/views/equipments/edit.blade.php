    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
                <form id="create" action="{{ route('equipments.update', ['equipment' => $equipment]) }}" method="POST"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            ...
                            <select
                                class="form-control js-select2 form-select form-control-alt @error('equipment_type') is-invalid @enderror"
                                name="equipment_type"
                                id="equipment_type">
                        ...
                        <div class="col-6">
                            ...
                            <select
                                class="form-control js-select2 form-select form-control-alt @error('status') is-invalid @enderror"
                                name="status"
                                id="status">
                        ...
                        <div class="col-6">
                            ...
                            <select
                                class="form-control js-select2 form-select form-control-alt @error('equipment_condition') is-invalid @enderror"
                        ...
                        <div class="form-check d-flex">
                            @if(!$equipment->images->isEmpty())
                                <div class="form-check form-switch">
                                    <form action="{{ route('images.delete_all', ['id' => $equipment->id]) }}"
                            ...
                            @foreach($equipment->images as $image)
                                <div class="col-md-3 mb-4 position-relative">
                                    ...
                                    <form action="{{ route('images.delete', ['id' => $image->id]) }}" method="POST"
                                          class="position-absolute top-0 end-0 form-delete">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-danger"
