    ...
    <div class="content">
        ...
        @if($equipment->workOrders->isNotEmpty())
            <div class="block block-rounded mb-4">
                <div class="block-content block-content-full d-flex align-items-center gap-1">
                    <span class="badge bg-success text-white me-2">
                        In Use
                    </span>
                    This equipment is currently using by
                    @php
                        $user = $equipment->workOrders->first()->user;
                    @endphp
                    <a href="@if(Auth::user()->is_admin) {{ route('users.show', $user) }} @else javascript:void(0) @endif">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="serial_number"
                               value="{{ $equipment->serial_number }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="manufacturer" class="form-label">Manufacturer</label>
                        <input type="text" class="form-control" id="manufacturer" value="{{ $equipment->manufacturer }}"
                               disabled>
                    </div>
                    <div class="col-6">
                        <label for="purchase_date" class="form-label">Purchase Date</label>
                        <input type="date" class="form-control" id="purchase_date"
                               value="{{ $equipment->purchase_date->format('Y-m-d') }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="location" class="form-label">Location</label>
                        <input type="text" class="form-control" id="location" value="{{ $equipment->location }}"
                               disabled>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <input type="date" class="form-control" id="warranty_period"
                               value="{{ $equipment->warranty_period->format('Y-m-d') }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="installation_date" class="form-label">Installation Date</label>
                        <input type="date" class="form-control" id="installation_date"
                               value="{{ $equipment->installation_date->format('Y-m-d') }}" disabled>
                    </div>
                    <div class="col-6">
                        ...
                        <input type="date" class="form-control" id="last_service_date"
                               value="{{ $equipment->last_service_date->format('Y-m-d') }}" disabled>
                    </div>
                    <div class="col-6">
                        ...
                        <input type="date" class="form-control" id="next_service_date"
                               value="{{ $equipment->next_service_date->format('Y-m-d') }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="equipment_condition" class="form-label">Equipment Condition</label>
                        <input type="text" class="form-control" id="equipment_condition"
                               value="{{ $equipment->equipment_condition }}" disabled>
                    </div>
                    <div class="col-12">
                        <label for="equipment_specifications" class="form-label">Equipment Specifications</label>
                        <textarea class="form-control" id="equipment_specifications"
                                  disabled>{{ $equipment->equipment_specifications }}</textarea>
                    </div>
                    <div class="col-6">
                        <label for="usage_duration" class="form-label">Usage Duration</label>
                        <input type="number" class="form-control" id="usage_duration"
                               value="{{ $equipment->usage_duration }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="power_requirements" class="form-label">Power Requirements</label>
                        <input type="text" class="form-control" id="power_requirements"
                               value="{{ $equipment->power_requirements }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="network_info" class="form-label">Network Info</label>
                        <input type="text" class="form-control" id="network_info" value="{{ $equipment->network_info }}"
                               disabled>
                    </div>
                    <div class="col-6">
                        <label for="software_version" class="form-label">Software Version</label>
                        <input type="text" class="form-control" id="software_version"
                               value="{{ $equipment->software_version }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="hardware_version" class="form-label">Hardware Version</label>
                        <input type="text" class="form-control" id="hardware_version"
                               value="{{ $equipment->hardware_version }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="purchase_price" class="form-label">Purchase Price</label>
                        <input type="number" step="0.01" class="form-control" id="purchase_price"
                               value="{{ $equipment->purchase_price }}" disabled>
                    </div>
                    <div class="col-6">
                        <label for="depreciation_value" class="form-label">Depreciation Value</label>
                        <input type="number" step="0.01" class="form-control" id="depreciation_value"
                               value="{{ $equipment->depreciation_value }}" disabled>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="row g-4">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="provider_name"
                                   value="{{ $equipment->warrantyInformation ? $equipment->warrantyInformation->provider_name : '' }}"
                                   disabled>
                        </div>
                        <div class="col-6">
                            <label for="provider_address" class="form-label">Provider Address</label>
                            <input type="text" class="form-control" id="provider_address"
